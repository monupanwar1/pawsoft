    ...
    <div className="flex items-center justify-center">
      {href ? (
        ...
        >
          <div
            className={cn(
              'group cursor-pointer border border-[#3B3A3A] bg-[#151515] gap-2 h-[64px] flex items-center p-[11px] rounded-full focus:outline-none focus-visible:outline-none ring-0 focus:ring-0',
              className,
            )}
          >
